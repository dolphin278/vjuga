...
function widen<T extends readonly unknown[], R>(fn: (...args: T) => R): Fn<readonly unknown[], unknown> {
...
console.log(`[memory] 1k memoize fns x100 entries: ${((heapAfter - heapBefore) / 1024 / 1024).toFixed(2)} MB`)
void memoFns

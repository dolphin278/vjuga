...
import { stringify, parseExn, parse } from '../JSON.js'
...
const nestedObj  = { user: { id: 1, name: 'Alice', roles: ['admin', 'user'] }, meta: { ts: 1234567890, version: 2 } }
...
console.log(`[memory] 100k JSON.parseExn(simple): ${((heapAfter - heapBefore) / 1024 / 1024).toFixed(2)} MB`)
void parsed
